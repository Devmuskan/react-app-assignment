...
// export const fetchHourlyForcastData = async (city: string | { lat: number; lng: number }) => {
//   let url = `${baseUrl}/forecast/hourly?q=${city}&appid=${process.env.REACT_APP_WEATHER_API_KEY}`;
  
//   if (typeof city === 'object') {
//     url = `${baseUrl}/forecast/hourly?lat=${city.lat}&lon=${city.lng}&appid=${process.env.REACT_APP_WEATHER_API_KEY}`;
//   }
